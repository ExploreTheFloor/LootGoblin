...
namespace LootGoblin.Windows
{
    public partial class Keyboard
    {
        ...
        public class Key //: UITypeEditor
        {
            ...
            public Key(Messaging.VKeys vk = Messaging.VKeys.NULL,
                Messaging.VKeys shiftKey = Messaging.VKeys.NULL,
                Messaging.ShiftType shiftType = Messaging.ShiftType.NONE)
            {
                _buttonCounter = 0;
                Vk = vk;
                ShiftKey = shiftKey;
            ...
            public bool PressBackground(IntPtr hWnd)
            {
                ...
                switch (ShiftType)
                {
                    ...
                    case Messaging.ShiftType.CTRL:
                        ...
                        break;
                    case Messaging.ShiftType.NONE:
                        if (!Messaging.SendMessageKey(hWnd, this, true))
                        {
                            _buttonCounter++;
                            if (_buttonCounter == 2)
                            {
